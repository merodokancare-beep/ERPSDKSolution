        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    //{
                    //    ModelState.AddModelError("", "Email has not been confirmed. Please confirm your email.");
                    //    //ViewBag.ErrCount = ModelState.Values.Count();
                    //    ModelState.Clear();
                    //    ViewBag.ErrMsg = "Email has not been confirmed. Please confirm your email...";
                    //    return View(model);
                    //}
                    else
                    {
