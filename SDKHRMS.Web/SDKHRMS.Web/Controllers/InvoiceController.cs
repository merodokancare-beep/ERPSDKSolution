...
namespace SDKHRMS.Web.Controllers
{
    ...
    public class InvoiceController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult PurchaseInvoice(PurchaseAddViewModel item, IFormFile UploaBill)
        {
            ViewBag.ActiveURL = "/Invoice/PurchaseInvoiceList";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditPurchaseInvoice(PurchaseAddViewModel item, IFormFile UploaBill)
        {
            ViewBag.ActiveURL = "/Invoice/PurchaseInvoiceList";
            string FileStatus = "Failure";
            if (UploaBill != null)
